...
function isCriticalUiLayer(layer, pageName){
  ...
  if(asset.includes('background-ui.png')) return true;
  if(asset.includes('background-ui-back-button.png')) return true;
  if(asset.includes('mail-ui.png')) return true;
  if(asset.includes('scanner-ui.png')) return true;
  if(asset.includes('data-log-ui.png')) return true;
...
function createLayer(layer, pageName, selectedId, opts){
  ...
  if(layer.type === 'image'){
    ...
    if(pageName === 'scanner' && (layer.name || '').includes('unknown_anomaly')) {
      ...
      el.classList.add('anomaly-detail-entity'); // static sizing only; CSS animation disabled
    }
    ...
    if(pageName === 'dataLog' && (layer.name || '').includes('unknown_anomaly')) {
      ...
      el.classList.add('data-log-entity-pulse'); // static anomaly only; CSS animation disabled
    }
...
function addHomeNodesToTracker(trackerEl){
  ...
  game.anomalies.forEach((a,i)=>{
    ...
    d.className='home-anomaly-node data-log-entity-pulse'; // static anomaly only; CSS animation disabled
