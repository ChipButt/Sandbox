...
const ASTRA_ASSET_VERSION = '20260521-animated-loops-github-v3';
...
function addHomeNodesToTracker(trackerEl){
  ...
  game.anomalies.forEach((a,i)=>{
    ...
    d.style.zIndex=6;
    const img=document.createElement('img');
    img.style.transform = `rotate(${pos.angle || 0}deg)`;
    img.dataset.centerFacingRotation = String(pos.angle || 0);
