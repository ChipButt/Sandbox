# Roll Britannia Forge Quest — Rune Scanner v3
...
```text
Test: Legendary Claim Rune
Test: Godlike Claim Rune
```

Important: if you claim Legendary at level 5, that completes the quest and you cannot continue to Godlike on that same browser save. Use the reset button in dev mode if you want to test Godlike afterwards.
